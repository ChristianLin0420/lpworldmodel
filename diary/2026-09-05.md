...
A single unchanged model spans only **0.08–0.24 across blocks**; the 0.165–0.585 span is across
...
**Eight of twelve do not survive; five are negative once seeds are matched.** Only `relu-p2` and

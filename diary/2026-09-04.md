...
**Two caveats, stated plainly.** This is a **1-step** residual on a **single fixed batch of 64**;
the planner rolls 5 steps, and independence at one step does not guarantee independence of the
compounded error. The natural follow-up — the same measurement on 5-step rollout residuals — is
one flag away and belongs in round 7 rather than here.

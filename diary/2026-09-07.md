...
| arm | n | SR | `d_action` |
|---|---|---|---|
| `st-tube` | 6 | **0.000** | 0.062 |
| `st-tube-w5` | 4 | **0.000** | 0.026 |
| `st-tube-iid` (its matched control) | 6 | **0.000** | 0.062 |
| `blockcausal` (the substrate) | 3 | **0.000** | -- |
| `LpWM-ltv` baseline | 13 | 0.357 | 0.28-0.40 |

`st-tube` vs `st-tube-iid`: **+0.000 at n = 5**. Both arms are dead, and their action channels
...
**Round 8 final scoreboard:** T3 `tjepa` **+0.010 at n = 8** (null; its double dose is -0.175);
ST1 `st-tube` **+0.000 at n = 5** (uninformative -- both arms' action channels are broken).
Twenty contrasts at n >= 8 across the campaign, still zero positives.

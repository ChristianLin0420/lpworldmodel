...
**P7 is null**: -0.073 against both its control and the baseline at n = 3, comfortably inside
the n = 3 MDE of ~0.27, with the control landing on the baseline exactly.

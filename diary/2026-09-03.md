...
| `cvar`, λ = 2 — mean + 2·std | more | 4 | 0.585 | −0.035 [−0.123, +0.053] |
| `max` — worst member | full | 3 | 0.540 | −0.067 [−0.170, +0.037] |

**Both halves of V1's pre-registered falsifier fire**: `max ≤ borda`, and λ > 0 is no better than
λ = 0. The `cvar1` cell is the decisive one at n = 8 — its interval [−0.055, +0.010] excludes any
meaningful *gain* from pessimism. `cvar2` and `max` are at n = 4 and n = 3 and only supply the

...
python analysis/round5_data_figs.py --out diary/assets/2026-09-03 \
       --campaign campaign.json                                        # §12, §12b, §14
...
| P2 `LpWM-linvar` | 5/8 | 0.0103 | 0.530 | 27.5 | 27.1 | — | 3 | 0.100 |
| P2 `PiWM-multact` | 7/8 | 0.0185 | 0.773 | 28.1 | 13.3 | — | 4 | 0.040 |
| P1 `PiWM-lie` | 8/8 | 0.0243 | 0.683 | 27.0 | 9.4 | — | 6 | 0.020 |
| P1b `PiWM-lie-sim` | 6/8 | 0.0210 | 0.697 | 27.5 | 8.8 | — | 6 | 0.020 |
| P3 `PiWM-actgain-b03` | 3/8 | 0.0111 | 0.467 | 23.5 | 16.0 | — | 3 | 0.400 |
| P3 `PiWM-actgain-b30` | 2/8 | 0.0114 | 0.389 | 20.1 | 22.3 | — | 0 | — |
| P4 `PiWM-ctrb` | 0/8 | 0.0156 | 0.518 | 21.2 | 19.8 | ctrb 0.230 | 0 | — |
| P5 `PiWM-actinfo-cond` | 3/8 | **1.0000** | 0.111 | 28.0 | 0.97 | act_info 1.609 | 1 | 0.000 |
| P5b `…-cond-sigreg` | 0/8 | **1.0993** | 1.000 | 10.2 | 4.0 | act_info 1.609 | 0 | — |
...
| contrast | vs | paired (n) | unpaired Welch |
|---|---|---|---|
| P2 `linvar` | `LpWM-ltv` | −0.427 [−0.76, −0.10] (3) | **−0.277 [−0.40, −0.16]**, p < 0.001 |
| P1 `lie` | `LpWM-ltv` | −0.380 [−0.53, −0.23] (6) | **−0.337 [−0.44, −0.24]**, p < 0.001 |
| P1b `lie-sim` | `PiWM-lie` | −0.005 [−0.04, +0.03] (4) | **+0.003 [−0.02, +0.03]**, p = 0.79 |
| P2 `multact` | `LpWM-linvar` | −0.000 (2, no interval) | −0.030 [−0.14, +0.08], p = 0.52 |
| P3 `actgain 0.3` | `LpWM-ltv` | −0.067 [−0.83, +0.70] (3) | −0.050 [−0.52, +0.42], p = 0.73 |
| P3 `actgain 3.0` | `LpWM-ltv` | — | — |
| P4 `ctrb` | `LpWM-linvar` | — | — |
| P5 `actinfo-knn` | `PiWM-actinfo` | +0.000 (1, no interval) | — |

![P1-P6 contrasts](assets/2026-09-03/p16-results.png)

### Correcting the round's own headline — twice

I have been quoting `actgain-b03` as "a null: −0.067". **That reading is not supported.** Its
95 % interval is [−0.52, +0.42] — it spans everything from "destroys planning" to "doubles it".
Three evaluated seeds cannot distinguish a null from a large effect in either direction, and
calling an uninformative interval a null is the same error as calling a fitted threshold a gate
(§8). The correct statement is: **P3 has not yet been measured.**

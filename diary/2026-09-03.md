...
| V1 pessimism | `vote5-borda`, `-cvar1`, `-cvar2`, `-max` × 8 | 32 evals launched |
| V2 gradient | `gd`, `gd-noise0` × 8 | 16 evals launched |
| V3 two-level | `2lvl` × 8 | 8 evals launched |
| T1–T3, T6 | decoder, patch+decoder, contact, jumpy | implementing (first attempt died on an API 500) |
...
| M4 | error analysis | unblocked — M2's traces now exist |
